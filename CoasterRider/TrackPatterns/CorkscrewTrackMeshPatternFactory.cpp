#include "CorkscrewTrackMeshPatternFactory.h"
#include <cassert>


/**########################################################
	CorkscrewTrackMeshPatternFactory() - construct a CorkscrewTrackMeshPatternFactory
#########################################################*/

CorkscrewTrackMeshPatternFactory::CorkscrewTrackMeshPatternFactory()
...
/**########################################################
	create() - create a new CorkscrewTrackMeshPattern.  Two rails,
...
TrackMeshPattern*CorkscrewTrackMeshPatternFactory::create(
...
/**#######################################################################
getinstance() - get the singleton instance of CorkscrewTrackMeshPatternFactory
########################################################################*/

CorkscrewTrackMeshPatternFactory*CorkscrewTrackMeshPatternFactory::getinstance()
	{
	static CorkscrewTrackMeshPatternFactory*instance=0;
	if(instance==0)
		{
		instance=new CorkscrewTrackMeshPatternFactory();
		}
	return instance;
	}
